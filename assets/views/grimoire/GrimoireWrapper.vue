<template>
    ...
    <GridLayout>
        <div>
            <BaseButton @click="() => showRoles('basic')">Add token</BaseButton>
    ...
    <RoleSelectModal
        ref="role-select-modal"
        :preset="roleSelectModalPreset"
        @role-click="setSeatRole"
    />
...
import type { IRoleSelectModalPreset } from "./RoleSelectModal.vue";
...
const roleSelectModalPreset = ref<IRoleSelectModalPreset>(null);
...
const showRoles = (preset: IRoleSelectModalPreset = null) => {
    roleSelectModalPreset.value = preset;
